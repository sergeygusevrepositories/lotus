...
wp_enqueue_style( 'signature-pad-css', plugin_dir_url( __FILE__ ) . 'css/signature-pad.css', array(), 1, 'all' );

wp_deregister_script('jquery');
wp_enqueue_script('jquery','//ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js','','',true);

wp_enqueue_script( 'signature-pad', plugin_dir_url( __FILE__ ) . 'js/signature_pad.umd.js', array( 'jquery' ), 2, true );
wp_enqueue_script( 'signature-app', plugin_dir_url( __FILE__ ) . 'js/app.js', array( 'jquery' ), 2, true );
