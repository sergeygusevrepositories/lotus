...
wp_enqueue_style( 'signature-pad-css', plugin_dir_url( __FILE__ ) . 'css/signature-pad.css', array(), 3, 'all' );
...
wp_enqueue_script( 'send-pdf-js-main', plugin_dir_url( __FILE__ ) . 'js/script.js', array( 'jquery' ), 3, true );
