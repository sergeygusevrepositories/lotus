...
if (!function_exists('add_scripts')) {
	function add_scripts() {
        ...
        wp_enqueue_script( 'fancy-box', get_theme_file_uri( '/libs/jquery.fancybox.min.js' ), array(), '1', true );
	}
}
...
if (!function_exists('add_styles')) {
	function add_styles() {
	    if(is_admin()) return false;
		wp_enqueue_style( 'main', get_template_directory_uri().'/css/styles.css?3' );
